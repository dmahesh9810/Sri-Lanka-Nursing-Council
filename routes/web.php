...
Route::middleware('auth')->group(function () {
    Route::middleware('role:Admin,User1,User2,User3,User4,User5')->group(function () {
    ...
    Route::middleware('role:Admin,User1,User2')->group(function () {
        Route::resource('temporary-registrations', TemporaryRegistrationController::class);
    });

    Route::middleware('role:Admin,User2,User3,User4,User5')->group(function () {
        Route::resource('permanent-registrations', PermanentRegistrationController::class);
    });

    Route::middleware('role:Admin,User3')->group(function () {
    ...
    Route::middleware('role:Admin,User4')->group(function () {
        Route::resource('additional-qualifications', AdditionalQualificationController::class);
    });

    Route::middleware('role:Admin,User5')->group(function () {
