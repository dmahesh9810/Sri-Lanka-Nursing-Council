...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .border-outer { border: 4px double #6c3483; padding: 12mm 12mm 10mm 12mm; min-height: 265mm; position: relative; }
        .border-inner { border: 1px solid #6c3483; padding: 8mm 10mm 8mm 10mm; min-height: 249mm; }
        .org-header { text-align: center; margin-bottom: 18pt; border-bottom: 2px solid #6c3483; padding-bottom: 12pt; }
        .org-emblem { font-size: 30pt; color: #6c3483; }
        .org-name   { font-size: 14pt; font-weight: bold; color: #6c3483; letter-spacing: 1px; text-transform: uppercase; }
        ...
        .cert-title       { font-size: 22pt; font-weight: bold; color: #6c3483; text-transform: uppercase; letter-spacing: 2px; margin: 4pt 0; }
        .cert-underline   { width: 80mm; border-bottom: 2px solid #6c3483; margin: 4pt auto 0 auto; }
...
<div class="border-inner">
    ...
    <div class="intro-text">
        This is to confirm the nursing qualification and registration details of the individual named
        herein as officially recorded by the Sri Lanka Nursing Council.
    </div>
    ...
    <div class="cert-body">
        This Certificate of Confirmation is issued by the Sri Lanka Nursing Council to confirm the
        qualifications, identity, and registration details of the nurse named above. This document
        serves as an official verification of nursing credentials for the purpose of employment or
        practice in the destination country. The Council assures the receiving authority that this
        information is accurate and maintained in accordance with the Nurses Ordinance No. 33 of 1953.
    </div>
